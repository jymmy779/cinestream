...
export const metadata: Metadata = {
  title: 'Giới Thiệu | CineStream - Xem Phim Online Chất Lượng Cao',
  description: 'Tìm hiểu về CineStream - Nền tảng xem phim trực tuyến miễn phí, chất lượng cao cực nét. Khám phá sứ mệnh và tầm nhìn của chúng tôi.',
  alternates: {
        ...
        <div className="p-6 md:p-12 space-y-6 md:space-y-10">
          <section>
            ...
            <div className="space-y-4 leading-relaxed text-xs md:text-sm opacity-60">
              <p>CineStream ra đời với sứ mệnh mang lại trải nghiệm xem phim trực tuyến hiện đại, mượt mà và hoàn toàn miễn phí cho cộng đồng yêu phim Việt Nam.</p>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-white/5 p-5 md:p-6 rounded-2xl border border-white/5 hover:border-[#D497FF]/20 transition-all group">
              ...
              <div className="space-y-3">
                <a href="#" className="flex items-center gap-2 md:gap-3 text-xs md:text-sm text-white/80 hover:text-amber-400 transition-colors break-all">
            ...
            <div className="bg-white/5 p-5 md:p-6 rounded-2xl border border-white/5 hover:border-[#0088cc]/30 transition-all group">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" title="Threads" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all">
          ...
          <div className="text-center pt-6 border-t border-white/5 italic text-[10px] md:text-xs opacity-20 uppercase tracking-widest">
            <p>© 2026 CineStream Team. Mọi quyền được bảo vệ.</p>
          </div>
        </div>
      </div>
    </div>
