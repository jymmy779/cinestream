...
export const metadata: Metadata = {
  title: 'Liên Hệ | CineStream - Hỗ Trợ 24/7',
  description: 'Liên hệ với tập thể phát triển CineStream. Giải đáp thắc mắc, gửi ý kiến đóng góp và yêu cầu phim mới nhất.',
  alternates: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-1 space-y-4 md:space-y-6">
            <div className="bg-[#12151C] border border-white/5 p-6 md:p-8 rounded-2xl md:rounded-[32px] hover:border-[#D497FF]/20 transition-all group shadow-xl">
              ...
              <a href="#" className="text-amber-400 font-bold text-xs md:text-sm hover:underline break-all">Contact details available in CV</a>
            </div>
            ...
            <div className="bg-[#12151C] border border-white/5 p-6 md:p-8 rounded-2xl md:rounded-[32px] hover:border-[#D497FF]/20 transition-all group shadow-xl">
              ...
              <a href="#" target='blank' className="text-[#D497FF] font-bold text-xs md:text-sm hover:underline">Portfolio demo</a>
            </div>
