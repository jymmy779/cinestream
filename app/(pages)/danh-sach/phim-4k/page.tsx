...
export const metadata: Metadata = {
    title: "Phim 4K Siêu Nét | LoFilm - Trải Nghiệm Điện Ảnh Đỉnh Cao",
    description: "Tuyển tập những bộ phim có chất lượng 4K siêu nét trên LoFilm. Xem phim 4K không quảng cáo, hình ảnh chân thực, âm thanh sống động.",
    keywords: [
        "phim 4k", "phim 4k vietsub", "xem phim 4k", "phim sieu net",
        "phim 4k mien phi", "lofilm 4k"
    ],
    alternates: {
