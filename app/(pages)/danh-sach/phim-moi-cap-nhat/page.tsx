...
export const metadata: Metadata = {
    title: "Phim Mới Cập Nhật Hôm Nay | CineStream - Phim Mới Nhất 2026 Vietsub",
    description: "Khám phá danh sách phim mới nhất được cập nhật mỗi ngày trên CineStream. Phim chiếu rạp, phim bộ, phim lẻ, anime vietsub chất lượng cao 4K. Luôn có phim mới nhất 2025-2026 mà bạn không muốn bỏ lỡ.",
    keywords: [
        "phim moi", "phim moi nhat", "phim moi cap nhat", "phim hay 2026",
        "phim moi hom nay", "phim chieu rap moi", "anime moi", "phim bo moi",
        "cinestream phim moi", "xem phim moi online", "phim 2026 moi nhat"
    ],
    alternates: {
